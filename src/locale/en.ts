const messages = {
    ...
    between: {
        numeric: ({ attribute, parameters: [ min, max ] }: any) => `The ${attribute} must be between ${min} and ${max}.`,
        string: ({ attribute, parameters: [ min, max ] }: any) => `The ${attribute} must be between ${min} and ${max} characters.`,
        array: ({ attribute, parameters: [ min, max ] }: any) => `The ${attribute} must have between ${min} and ${max} items.`,
    },
    ...
    max: {
        numeric: ({ attribute, parameters: [ max ] }: any) => `The ${attribute} may not be greater than ${max}.`,
        string: ({ attribute, parameters: [ max ] }: any) => `The ${attribute} may not be greater than ${max} characters.`,
        array: ({ attribute, parameters: [ max ] }: any) => `The ${attribute} may not have more than ${max} items.`,
    },
    min: {
        numeric: ({ attribute, parameters: [ min ] }: any) => `The ${attribute} must be at least ${min}.`,
        string: ({ attribute, parameters: [ min ] }: any) => `The ${attribute} must be at least ${min} characters.`,
        array: ({ attribute, parameters: [ min ] }: any) => `The ${attribute} must have at least ${min} items.`,
    },
    ...
    size: {
        numeric: ({ attribute, parameters: [ size ] }: any) => `The ${attribute} must be ${size}.`,
        string: ({ attribute, parameters: [ size ] }: any) => `The ${attribute} must be ${size} characters.`,
        array: ({ attribute, parameters: [ size ] }: any) => `The ${attribute} must contain ${size} items.`,
    },
